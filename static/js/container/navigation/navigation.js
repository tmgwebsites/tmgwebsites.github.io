...
function Navigation(props) {
    ...
    const classesBottomNav = useStylesBottomNavigation({
        isRevive
    });
    ...
    return ( <
        div className = {
            `navigation navigation${isRevive ? "--revive" : ""}`
        } >
        <
        ...
        /Grid> {
            isMobile && !isRevive ? ( <
                div >
                <
                img className = "navigation__menu"
                src = {
                    hamburgerMenu
                }
                ...
                MenuItem classes = {
                    {
                        root: classesMenuItem[value === "hiring" ? "root" : "default"],
                    }
                }
                onClick = {
                    () => handleUpdate("hiring")
                ...
                MenuItem classes = {
                    {
                        root: classesMenuItem[value === "about" ? "root" : "default"],
                    }
                }
                onClick = {
                    () => handleUpdate("about")
                ...
                MenuItem classes = {
                    {
                        root: classesMenuItem[value === "team" ? "root" : "default"],
                    }
                }
                onClick = {
                    () => handleUpdate("team")
