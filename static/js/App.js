...
class App extends React.Component {
        ...
        render() {
            ...
            return ( <
                ...
                <
                CssBaseline / > { < div className = {
                        `app-container app-container${isRevive ? '--revive' : ''}`
                    } >
                    <
                    Navigation routeUpdate = {
                        (page) => this.routeUpdate(page, history)
                    }
                    isRevive = {
                        isRevive
                    }
                    ...
                    /> <
                    /Route> <
                    Route path = "/revive/caseone"
                    exact >
                    <
                    CaseOne / >
                    <
                    /Route> <
                    Route path = "/revive/timeline"
                    exact >
                    <
                    Timeline / >
                    <
                    /Route> <
                    Route path = "/revive/history"
                    exact >
                    <
                    History / >
                    <
                    /Route> <
                    Route path = "/revive/faq"
                    exact >
                    <
                    Faq / >
                    <
                    /Route> <
                    Route path = "/revive/sponsor"
                    exact >
                    <
                    Sponsor / >
                    <
                    /Route> <
                    Route path = "/revive/package"
                    exact >
                    <
                    Package / >
                    <
