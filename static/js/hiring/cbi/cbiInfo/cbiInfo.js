        ...
        render() {
            ...
            return ( <
                ...
                Container maxWidth = "lg" > {
                    ...
                    onClick = {
                        () =>
                        window.open("https://form.jotform.com/201816278499266", "_blank")
                    } > Apply Now < /Button> <
                    /div> <
                    ...
                    <
                    Typography variant = "body1"
                    color = "primary" > Your Role : < /Typography> <
                        ul > {
                        ...
                        /div> <
                        Typography variant = "body1"
                    color = "primary" > Benefits: < /Typography> <
                        ...
                        <
                        Typography variant = "body1"
                    color = "primary" > Skills Required: < /Typography> <
                        ul > {
                    ...
                    className = "info__link" > Click to go back to Main Page < /Typography> <
                    /Link>} <
                    /Container> <
                    /div>
                );
