...
function Hiring(props) {
    ...
    return ( <
        ...
        The Marketing Group is back and better than ever!This time around we are looking
        for your help to get the ball rolling.In early 2021 we will be hosting a global marketing
        case competition full of challenges, speaker events, networking and more.Be a part of the team that makes this happen.Grow your network.Engage with your peers.Unleash your pink sheep!Check out how you can get involved and become a Campus Brand Influencer at your university.We can 't wait to have you join
        our herd!
        <
        /Typography> <
        /div> <
        StyledFont variant = "subtitle1"
        color = "primary" >
        <
        ...
        <
        Typography variant = "body1" >
        The Marketing Group offers a variety of Director positions every year to empower students to unleash their pink sheep.Apply now and work together with like - minded individuals to execute our plans
        for this year!
        <
        /Typography> <
        /div> <
        ...
        <
        Typography variant = "body1" >
        The Marketing Group hires new Presidents and Vice Presidents every year.These leadership positions are tailored
        for students who truly want to make a difference and take their undergraduate experience to the next level. <
        /Typography> <
        /div> <
        div className = "hiring__deadline" >
        <
        ...
        /Grid> {
            (props.login.authenticated ||
                ...
                { <
                    ...
                    name = "blurb"
                    onBlur = {
                        (e) => handleBlur(e, "blurb")
                    }
                    onChange = {
                        (e) => handleText(e, "blurb")
                    }
                    /> {
                        blurbError && ( <
                            Alert severity = "error" >
