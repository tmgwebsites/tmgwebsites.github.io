...
function CaseOne(props) {
    ...
    function onDocument2LoadSuccess({
        numPages
    }) {
    ...
    function onPageLoadSuccess({
        ...
        setPreviousPage( < Page pageNumber = {
                pageNumber
            }
            />);
        }

        function onPage2LoadSuccess({
            pageNumber
        }) {
            setPreviousPage2( < Page pageNumber = {
                    pageNumber
                }
                />);
            }
            ...
            return ( <
                ...
                case mark the beginning of your journey with us, it 's also an ode to months of brainstorming, 
                planning and execution by our leadersheep team at The Marketing Group.Our goal was to revive a marketing club from the ashes of the unknown, create a student conference like none other and provide students around the world with an opportunity to spread their marketing wings in a realistic setting.Consider this goal achieved. <
                /StyledHeader> <
                /div> <
                /Grid> <
                Grid item md = {
                ...
                <
                a className = "caseOne__underline"
                target = "_blank"
                ...
                div className = "caseOne__body2" >
                <
                Typography className = "caseOne__download"
                variant = "subtitle1" > {
                    " "
                } <
                a className = "caseOne__underline"
